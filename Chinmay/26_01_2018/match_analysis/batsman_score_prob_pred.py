# -*- coding: utf-8 -*-
"""
Created on Wed Jan 24 23:23:46 2018
...
def score_predict(batsman , bowlers , team1 , team2 , match_type):
    ...
    print(batsman , "actually scored against bowlwers" , sum(predicted))
...
against_bowlers,overall,home_away = score_predict('SPD Smith' , bowlers_1 , team2 , team1 , match_type)
