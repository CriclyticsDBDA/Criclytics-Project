...
for team in teams:
    ...
    for batsman in batsmans:
        ...
        for mindex in match_index:
            ...
            #print(mindex)
            #break
        batsman_data.columns = ['match_id', 'for team' ,'name', 'match_type' , 'date' , 'neutral' , 'against' , 'venue', 'runs' , 'balls_faced']
...
batsman_data_team = batsman_data[(batsman_data['against'] == 'England')]
...
#    pred_x.append([f,b])
#Predict Output 
predicted= model.predict([[  avg_balls,    7.]])
print(predicted)
